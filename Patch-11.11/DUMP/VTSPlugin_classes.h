...
struct UVTSAuthorityPlayerTimelineSynchronizer : UVTSPlayerTimelineSynchronizer {
	...
	void Rebase(); // Function VTSPlugin.VTSAuthorityPlayerTimelineSynchronizer.Rebase // (Final|Native|Public|BlueprintCallable) // @ game+0x51aa5f0
};
...
struct UVTSAutonomousPlayerTimelineSynchronizer : UVTSPlayerTimelineSynchronizer {
	...
	void Rebase(); // Function VTSPlugin.VTSAutonomousPlayerTimelineSynchronizer.Rebase // (Final|Native|Public|BlueprintCallable) // @ game+0x51aab60
};
...
struct UVTSFixedTimeStepTimelineAPI : UObject {
	...
	void UnregisterTimeSynchronizedObjectBlueprint(struct UObject* TimeSynchronizedObjectBlueprint); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.UnregisterTimeSynchronizedObjectBlueprint // (Final|Native|Public|BlueprintCallable|Const) // @ game+0x51ab7f0
	bool SetTimeStampDelegateBlueprint(struct FVTSTimeStampIndex& TimeStampIndex, struct FDelegate TimeStampActionDynamicDelegate); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.SetTimeStampDelegateBlueprint // (Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const) // @ game+0x51ab610
	void RegisterTimeSynchronizedObjectBlueprint(struct UObject* TimeSynchronizedObjectBlueprint); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.RegisterTimeSynchronizedObjectBlueprint // (Final|Native|Public|BlueprintCallable|Const) // @ game+0x51ab9c0
	float GetRemainingRequiredSimulationTime(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetRemainingRequiredSimulationTime // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x51ab5d0
	float GetInterpolationValue(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetInterpolationValue // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x51ab540
	float GetFixedTimeStepSize(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetFixedTimeStepSize // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x51ab590
	struct FVTSTimeStampIndex GetCurrentTimeStampIndex(); // Function VTSPlugin.VTSFixedTimeStepTimelineAPI.GetCurrentTimeStampIndex // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x51ab5b0
};
...
struct UVTSTimeSynchronizedInterfaceBlueprint : UInterface {
	...
	void OnRebaseBlueprint(); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnRebaseBlueprint // (Event|Public|BlueprintEvent) // @ game+0x19be2f0
	void OnPreFixedTimeStepsBlueprint(float ResidualTimeSeconds); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnPreFixedTimeStepsBlueprint // (Event|Public|BlueprintEvent) // @ game+0x19be2f0
	void OnPostFixedTimeStepsBlueprint(float ResidualTimeSeconds); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnPostFixedTimeStepsBlueprint // (Event|Public|BlueprintEvent) // @ game+0x19be2f0
	void OnFixedTimeStepBlueprint(struct FVTSTimeStampIndex& TimeStampIndex); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.OnFixedTimeStepBlueprint // (Event|Public|HasOutParms|BlueprintEvent) // @ game+0x19be2f0
	int32_t GetFixedTimeStepPriorityBlueprint(); // Function VTSPlugin.VTSTimeSynchronizedInterfaceBlueprint.GetFixedTimeStepPriorityBlueprint // (Event|Public|BlueprintEvent|Const) // @ game+0x19be2f0
};
